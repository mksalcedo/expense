...
namespace Expense.Domain.Migrations
{
    ...
    [Migration("20260730105556_AddCategoryIdToForecastSnapshotLine")]
    partial class AddCategoryIdToForecastSnapshotLine
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Expense.Domain.Entities.PaymentConfirmation", b =>
                {
                    ...
                    b.HasIndex("AccountId", "OriginalDate")
                        .IsUnique()
                        .HasDatabaseName("ix_payment_confirmations_account_id_original_date");
